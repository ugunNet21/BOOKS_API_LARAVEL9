                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="title" type="text"
                                                ...
                                                value="{{ $banner->title }}" required autofocus>
                                            @error('title')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address"
                                                rows="4">{{ $banner->address }}</textarea>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <select id="banner_category_id"
                                                ...
                                                @foreach ($categoriesBanner as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ $banner->banner_category_id == $category->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select id="status" class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                <option value="aktif" {{ $banner->status == 'aktif' ? 'selected' : '' }}>Aktif
                                                </option>
                                                <option value="tidak aktif"
                                                    {{ $banner->status == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif
                                                </option>
                                            </select>
                                            @error('status')
                                                <span class="invalid-feedback" role="alert">
