...
@section('title', 'Edit About - My Bio')
            ...
            <div class="page-content">
                <div class="content-heading">
                    <div class="heading-left">
                        ...
                        <p class="page-subtitle">Edit existing about information</p>
                    </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('abouts.update', $about->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" class="form-control" rows="4" required>{{ old('address', $about->address) }}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="projects_completed" id="projects_completed" class="form-control"
                                        value="{{ old('projects_completed', $about->projects_completed) }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="happy_clients" id="happy_clients" class="form-control" rows="4"
                                        value="{{ old('happy_clients', $about->happy_clients) }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        ...
                                        <option value="aktif" {{ old('status', $about->status) == 'aktif' ? 'selected' : '' }}>
                                            Aktif
                                        </option>
                                        <option value="tidak aktif"
                                            {{ old('status', $about->status) == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif
                                        </option>
                                    </select>
                                </div><br>
